!function($, wysi) {
    ...
    var templates = function(key, locale) {
        ...
        var tpl = {
            ...
            "emphasis":
                "<li>" +
                  "<div class='btn-group'>" +
                    "<a class='btn btn-small' data-wysihtml5-command='bold' title='CTRL+B'>B</a>" +
                    "<a class='btn btn-small' data-wysihtml5-command='italic' title='CTRL+I'>I</a>" +
                    "<a class='btn btn-small' data-wysihtml5-command='underline' title='CTRL+U'>U</a>" +
                  "</div>" +
                "</li>",
                ...
                "<li>" +
                  "<div class='bootstrap-wysihtml5-insert-link-modal modal hide fade'>" +
                    ...
                    "<div class='modal-body'>" +
                      "<input value='http://' class='bootstrap-wysihtml5-insert-link-url span6'>" +
                    "</div>" +
            ...
            "image":
                "<li>" +
                  "<div class='bootstrap-wysihtml5-insert-image-modal modal hide fade'>" +
                    ...
                    "</div>" +
                    "<div class='modal-body'>" +
                      "<input value='http://' class='bootstrap-wysihtml5-insert-image-url span6'>" +
                    "</div>" +
                    "<div class='modal-footer'>" +
    ...
    var defaultOptions = $.fn.wysihtml5.defaultOptions = {
        ...
        //stylesheets: ["/assets/blackline/css/wysiwyg-color.css"], // (path_to_project/lib/css/wysiwyg-color.css)
        locale: "en"
    };
